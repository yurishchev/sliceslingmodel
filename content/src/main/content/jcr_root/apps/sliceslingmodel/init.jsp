<%@page session="false"%><%--
  ...
  Vladimir's note.
  It's an overridden version: we need to refresh page when author presses preview icon.
...
<script type="text/javascript">
    ...
    <%-- We need to override standard behaviour and refresh page when author presses preview icon --%>
